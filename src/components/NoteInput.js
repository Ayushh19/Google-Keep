...
// //   const [expanded, setExpanded] = useState(false);
// //   const [notes, setNotes] = useState([]);
// //   const [isListView, setIsListView] = useState(false); // State to manage view mode
...
// //           marginLeft: "250px",
// //           marginTop: "20px",
// //           width: isListView ? "600px" : "calc(100% - 250px)",
// //         }}
// //       >
// //         {notes.map((note) => (
// //           <NotesThird
...
//           marginLeft: "250px",
//           marginTop: "20px",
//           width: isListView ? "calc(100% - 250px)" : "calc(100% - 250px)", // Adjust width for list view
//         }}
//       >
//         {notes.map((note) => (
//           <NotesThird
...
//             fetchNotes={fetchNotes}
//             sx={{
//               width: isListView ? "90%" : "auto", // Increased width of individual notes
//               maxWidth: "800px", // Prevents them from being too large
//               margin: isListView ? "8px 0" : "8px",
//             }}
//           />
//         ))}
