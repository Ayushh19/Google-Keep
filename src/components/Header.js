...
const Search = styled("div")(({ theme }) => ({
  ...
  marginLeft: theme.spacing(5), // Increased left margin
  width: "40%", // Reduced width slightly
  [theme.breakpoints.up("sm")]: {
    marginLeft: theme.spacing(8), // More left margin for larger screens
    width: "50%", // Slightly reduced width on larger screens
  },
}));
